 ...
 *
 */
public class JDialogPuestoEditar extends javax.swing.JDialog {
    ...
    public JDialogPuestoEditar(java.awt.Frame parent, Puesto puesto) {
        super(parent, true);
        initComponents();
        ...
        try {
            ...
            short ZERO = 0;
            DepartamentoPage page = dc.find(new String(), 0, MAX_VALUE, ZERO);
            departamentos = page.getData();
            if(departamentos == null){
                departamentos = new ArrayList<>();
            }
            departamentos.sort(new Comparator<Departamento>() {
                @Override
            ...
            for (int i = 0; i < departamentos.size(); i++) {
                jComboBoxDepartamento.addItem(departamentos.get(i).getNombre());
            }
            int selectDeault = departamentos.indexOf(puesto.getDepartamento());
            if(selectDeault >= 0 || departamentos.size() > 0 ){
                jComboBoxDepartamento.setSelectedIndex(selectDeault);
            }
            ...
            this.dispose();
            Logger.getLogger(JDialogPuestoEditar.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        Proceso p = new Proceso(this) {
            ...
            public void proceso() {
                ...
                if (auth.isNotValid(Auth.TIPO_ALFA_NUMERIC_SPACE_WITH_SPECIAL_SYMBOLS, Puesto.SIZE_NOMBRE, nombre)) {
                    setVisible(false);
                    JOptionPane.showMessageDialog(THIS, "El nombre no es valido", "Warnig", JOptionPane.WARNING_MESSAGE);
                }
                if (auth.isNotValid(Auth.TIPO_ALFA_NUMERIC_SPACE_WITH_SPECIAL_SYMBOLS, Puesto.SIZE_DESCRIPCION, descripcion)) {
                    setVisible(false);
                    ...
                    try {
                        ...
                        if(select < 0){
                            JOptionPane.showMessageDialog(THIS, "Accion no valida", "Warnig", JOptionPane.WARNING_MESSAGE);
                        }
                        ...
                        puestoController.update(puesto);
                        THIS.dispose();
                    } catch (Exception e) {
                        setVisible(false);
    ...
    private void jTextFieldNombreKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldNombreKeyTyped
        ...
        if (auth.isNotValid(Auth.TIPO_ALFA_NUMERIC_SPACE_WITH_SPECIAL_SYMBOLS, Puesto.SIZE_NOMBRE, text)) {
            evt.consume();
        }
    ...
    private void jTextPaneDescripcionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextPaneDescripcionKeyTyped
        ...
        if (auth.isNotValid(Auth.TIPO_ALFA_NUMERIC_SPACE_WITH_SPECIAL_SYMBOLS, Puesto.SIZE_DESCRIPCION, text)) {
            evt.consume();
        }
