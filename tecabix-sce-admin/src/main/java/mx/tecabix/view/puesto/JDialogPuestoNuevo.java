 ...
 *
 */
public class JDialogPuestoNuevo extends javax.swing.JDialog {

    private Auth auth = new Auth();
    private List<Departamento> departamentos;

    public JDialogPuestoNuevo(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
        ...
        try {
            ...
            this.dispose();
            Logger.getLogger(JDialogPuestoNuevo.class.getName()).log(Level.SEVERE, null, ex);
