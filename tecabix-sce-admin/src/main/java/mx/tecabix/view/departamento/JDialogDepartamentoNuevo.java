 ...
 *
 */
public class JDialogDepartamentoNuevo extends javax.swing.JDialog {

    private Auth auth = new Auth();

    public JDialogDepartamentoNuevo(java.awt.Frame parent) {
        super(parent, true);
        initComponents();
            ...
            public void proceso() {
                ...
                if (auth.isNotValid(Auth.TIPO_ALFA_NUMERIC_SPACE_WITH_SPECIAL_SYMBOLS, Departamento.SIZE_DESCRIPCION, descripcion)) {
                    ...
                    try {
                        ...
                        departamentoController.save(departamento);
                        THIS.dispose();
                    } catch (Exception e) {
                        setVisible(false);
