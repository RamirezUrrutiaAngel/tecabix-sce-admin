 ...
 *
 */
public class JDialogDepartamentoVer extends javax.swing.JDialog {

    private Auth auth = new Auth();

    public JDialogDepartamentoVer(java.awt.Frame parent, Departamento departamento) {
        super(parent, true);
        initComponents();
