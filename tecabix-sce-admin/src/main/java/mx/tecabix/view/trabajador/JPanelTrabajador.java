...
import mx.tecabix.view.departamento.*;
 ...
 * 
 */
public class JPanelTrabajador extends javax.swing.JPanel {
    ...
    private final short PUESTO = 2;
    private final short PLANTEL = 3;
    private final short NUM_COLUMNAS = 4;
    ...
    public JPanelTrabajador(JFrame parent) {
        initComponents();
        this.auth = new Auth();
        this.parent = parent;
    ...
    private void cargarTabla(){
        try {
            ...
            header[CURP] = "CURP";
            header[PUESTO] = "PUESTO";
            header[PLANTEL] = "PLANTEL";
            Class[] headerType = new Class[NUM_COLUMNAS];

            headerType[NOMBRE] = java.lang.String.class;
            headerType[CURP] = java.lang.String.class;
            headerType[PUESTO] = java.lang.String.class;
            headerType[PLANTEL] = java.lang.String.class;
            ...
            for (int i = 0; i < trabajadores.size(); i++) {
                ...
                StringBuilder nombre = new StringBuilder(personaFisica.getNombre());
                if(personaFisica.getApellidoPaterno()!= null && !personaFisica.getApellidoPaterno().trim().isEmpty()){
                    nombre.append(" ");
                    nombre.append(personaFisica.getApellidoPaterno());
                }
                if(personaFisica.getApellidoMaterno()!= null && !personaFisica.getApellidoMaterno().trim().isEmpty()){
                    nombre.append(" ");
                    nombre.append(personaFisica.getApellidoMaterno());
                }
    ...
    private void formatearTabla(){
        try {
            ...
            jTable.getColumnModel().getColumn(NOMBRE).setMinWidth(600);
            jTable.getColumnModel().getColumn(NOMBRE).setMaxWidth(700);
            jTable.getColumnModel().getColumn(CURP).setMinWidth(200);
            jTable.getColumnModel().getColumn(PUESTO).setMinWidth(200);
            jTable.getColumnModel().getColumn(PLANTEL).setMinWidth(300);
