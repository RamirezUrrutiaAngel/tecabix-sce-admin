 ...
 *
 */
public class JDialogPlantelEditar extends javax.swing.JDialog {
    ...
    public JDialogPlantelEditar(java.awt.Frame parent, JPanelPlantel jPanelPlantel, Plantel plantel) {
        super(parent, true);
        initComponents();
        ...
        Proceso p = new Proceso(parent) {
            ...
            public void proceso() {
                ...
                if (ex != null) {
                    ...
                    Logger.getLogger(JDialogPlantelEditar.class.getName()).log(Level.SEVERE, null, ex);
                ...
                int select = municipios.indexOf(municipio);
                jComboBoxMunicipio.setSelectedIndex(select);
    ...
    private Exception cargarEstado() {
        try {
            ...
            int select = estados.indexOf(plantel.getDireccion().getMunicipio().getEntidadFederativa());
            jComboBoxEstado.setSelectedIndex(select);
            return null;
        } catch (Exception ex) {
            Logger.getLogger(JDialogPlantelEditar.class.getName()).log(Level.SEVERE, null, ex);
            return ex;
        ...
        Proceso p = new Proceso(THIS) {
            ...
            public void proceso() {
                try {
                    ...
                    PlantelController plantelController = new PlantelController();
                    plantelController.update(plantel);
                    THIS.dispose();
                    jPanelPlantel.init();
                } catch (Exception ex) {
                    Logger.getLogger(JDialogPlantelEditar.class.getName()).log(Level.SEVERE, null, ex);
